...
namespace Projeto1
{
    public partial class frmLogin : Form
    {
        ...
        private void btnEntrar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql = "select * from tbLogin where usuario=@user and senha=@senha"; //sellecionar de Login usuario e senha
                MySqlCommand cmd = new MySqlCommand(sql, con.ConnectarBD()); //conectar nosql
                ...
                else
                {
                    txtUsuario.Clear();
                    txtSenha.Clear();
                    txtUsuario.Focus(); //espaço já selecionado
                }
            } 
            ...
            {
                con.DesConnectarBD();//desconectar
            }
        }
    }
}
